...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { address: @instructor.address, dob: @instructor.dob, gender: @instructor.gender, name: @instructor.name, phone: @instructor.phone, transmission: @instructor.transmission } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { address: @instructor.address, dob: @instructor.dob, gender: @instructor.gender, name: @instructor.name, phone: @instructor.phone, transmission: @instructor.transmission } }
